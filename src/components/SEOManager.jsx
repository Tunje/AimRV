...
const SEOManager = () => {
  ...
  const [metaTexts, setMetaTexts] = useState({
    ...
    "meta-description-home":
      "Aim Challenge är en multisport tävling som passar för alla. Lag på två personer ska under 6 timmar ta så många kontroller som möjligt.",
    "meta-keywords-home":
      "multisport, tävling, aim challenge, orientering, löpning, cykling",
    "meta-title-om-oss": "Om Oss - Aim Challenge",
    "meta-description-om-oss":
      "Lär dig mer om Aim Challenge organisationen och vår mission.",
    "meta-title-regler": "Regler - Aim Challenge",
    "meta-description-regler":
      "Tävlingsregler och riktlinjer för Aim Challenge evenemang.",
    "meta-title-senaste-nytt": "Senaste Nytt - Aim Challenge",
    "meta-description-senaste-nytt":
      "Senaste nytt och uppdateringar från Aim Challenge.",
  });
  ...
  return (
    <div
      className="seo-manager-container"
      style={{ padding: "40px", maxWidth: "1200px", margin: "0 auto" }}
    >
      <h2 className="font_blue fonts_large" style={{ marginBottom: "30px" }}>
        SEO Hanterare
      </h2>
      ...
      >
        ...
        <button
          ...
          style={{
            padding: "8px 16px",
            backgroundColor:
              activeTab === "sharingImages" ? "#0984e3" : "#e0e0e0",
      ...
      {activeTab === "metaTexts" && (
        <div className="meta-texts-section">
          <p style={{ marginBottom: "20px" }}>
            Redigera meta-texter för att förbättra sökmotoroptimering (SEO) för
            din webbplats.
          </p>
      ...
      {activeTab === "sharingImages" && (
        <div className="sharing-images-section">
          <p style={{ marginBottom: "20px" }}>
            Ladda upp bilder som kommer att visas när dina sidor delas på
            sociala medier.
          </p>
