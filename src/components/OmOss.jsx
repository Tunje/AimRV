      ...
      <div className="om-oss-container">
        ...
        <section className="om-oss-hero-section">
          <div className="hero-content">
            <div
              className="hero-image-container background-editable"
              id="om-oss-hero-image"
            >
              <img
        ...
        <div
          className="om-oss-background-container locked-background background-editable"
          id="om-oss-background-image"
        ></div>
        ...
        <section className="om-oss-section flex flex_j_C flex_a_C ">
          <div className="om-oss-content MaxWH flex flex_col flex_j_C">
            <div className="om-oss-content-wrapper">
              <EditableText
                textKey="om-oss-title-3"
                defaultText="En tävling för alla – oavsett nivå"
                tag="h2"
                className="fonts_large om-oss-title"
              />
              ...
              <EditableText
                ...
                defaultText="Välkommen till AIM Challenge – multisport för alla!"
                tag="p"
                className="fonts_small om-oss-text"
              />
            </div>
