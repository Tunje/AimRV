...
const ResultUploadModal = ({
  ...
  const handleSubmit = async (e) => {
    ...
    if (currentUser.role !== "admin") {
      setError("Only administrators can upload result files");
      return;
    }
    ...
    try {
      ...
      const fileName = `${yearState}_${category}_${duration}_${Date.now()}_${
        file.name
      }`;
      ...
      const metadata = {
        ...
        customMetadata: {
          ...
          isAdminUpload: currentUser.role === "admin" ? true : false,
        },
      };
      ...
      uploadTask.on(
        ...
        async () => {
          ...
          const resultData = {
            ...
            uploadedBy: currentUser.uid,
            uploadedByEmail: currentUser.email,
            isAdminUpload: currentUser.role === "admin",
          };
    ...
    <div className="result-upload-modal-overlay">
      <div className="result-upload-modal">
        <div className="result-upload-modal-header">
          ...
          <button className="result-upload-modal-close" onClick={onClose}>
            &times;
          </button>
        </div>
          ...
          <form className="result-upload-modal-form" onSubmit={handleSubmit}>
            ...
            {isUploading && (
              <div className="result-upload-modal-progress">
                <div
                  className="result-upload-modal-progress-bar"
                  style={{ width: `${uploadProgress}%` }}
                ></div>
                <div className="result-upload-modal-progress-text">
